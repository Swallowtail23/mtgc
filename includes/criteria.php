...
elseif (!$adv == "yes" ) :
    ...
    if (strlen($name) > 2): // Needs to have more than 2 characters to search
        if ($exact === "yes"):
            $criteria = "cards_scry.name LIKE '$name' OR cards_scry.f1_name LIKE '$name' OR cards_scry.f2_name LIKE '$name' OR cards_scry.printed_name LIKE '$name' OR cards_scry.f1_printed_name LIKE '$name' OR cards_scry.f2_printed_name LIKE '$name' OR cards_scry.flavor_name LIKE '$name' OR cards_scry.f1_flavor_name LIKE '$name' OR cards_scry.f2_flavor_name LIKE '$name' ";
        else:
            $criteria = "cards_scry.name LIKE '%$name%' OR cards_scry.f1_name LIKE '%$name%' OR cards_scry.f2_name LIKE '%$name%' OR cards_scry.printed_name LIKE '%$name%' OR cards_scry.f1_printed_name LIKE '%$name%' OR cards_scry.f2_printed_name LIKE '%$name%' OR cards_scry.flavor_name LIKE '%$name%' OR cards_scry.f1_flavor_name LIKE '%$name%' OR cards_scry.f2_flavor_name LIKE '%$name%' ";
        endif;
...
elseif ($adv == "yes" ) :
    ...
    elseif (empty($searchname) AND empty($searchtype) AND empty($searchability) AND empty($searchabilityexact)):
        ...
        if ($searchname === "yes"):
            if ($exact === "yes"):
                $criteriaNTA = "cards_scry.name LIKE '$name' OR cards_scry.f1_name LIKE '$name' OR cards_scry.f2_name LIKE '$name' OR cards_scry.printed_name LIKE '$name' OR cards_scry.f1_printed_name LIKE '$name' OR cards_scry.f2_printed_name LIKE '$name' OR cards_scry.flavor_name LIKE '$name' OR cards_scry.f1_flavor_name LIKE '$name' OR cards_scry.f2_flavor_name LIKE '$name' ";
            else:
                $criteriaNTA = "cards_scry.name LIKE '%$name%' OR cards_scry.f1_name LIKE '%$name%' OR cards_scry.f2_name LIKE '%$name%' OR cards_scry.printed_name LIKE '%$name%' OR cards_scry.f1_printed_name LIKE '%$name%' OR cards_scry.f2_printed_name LIKE '%$name%' OR cards_scry.flavor_name LIKE '%$name%' OR cards_scry.f1_flavor_name LIKE '%$name%' OR cards_scry.f2_flavor_name LIKE '%$name%' ";
            endif;
        endif;
