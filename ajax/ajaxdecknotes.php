...
if ($isValidReferrer):
    ...
    if (!isset($_SESSION["logged"], $_SESSION['user']) || $_SESSION["logged"] !== TRUE): 
        ...
        $msg->logMessage('[NOTICE]',"Called with: Notes: $newnotes, Side notes: $newsidenotes, Deck number: $decknumber");
        ...
        try {
            ...
            trigger_error("[ERROR] ajaxdecknotes.php: " . $e->getMessage() . " SQLSTATE: " . $db->errorInfo()[0], E_USER_ERROR);
            http_response_code(400);
