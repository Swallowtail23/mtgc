...
class BulkDbStub
{
    ...
    {
        unset($params);
        // The repository calls this for game type queries.
        // Return a result with the default seed data for policy construction.
        ...
        // For BEGIN/COMMIT/ROLLBACK, return true
        $trimmed = trim($query);
